# encoding: utf-8
# module _curses
# from /usr/local/lib/python3.8/lib-dynload/_curses.cpython-38-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
_C_API = None # (!) real value is '<capsule object "_curses._C_API" at 0x7f7004d012d0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f7004d01af0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_curses', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f7004d01af0>, origin='/usr/local/lib/python3.8/lib-dynload/_curses.cpython-38-x86_64-linux-gnu.so')"
