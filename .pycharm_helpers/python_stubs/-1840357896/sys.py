...
version = '3.8.2 (default, Apr 23 2020, 14:22:33) \n[GCC 8.3.0]'
...
implementation = None # (!) real value is "namespace(_multiarch='x86_64-linux-gnu', cache_tag='cpython-38', hexversion=50856688, name='cpython', version=sys.version_info(major=3, minor=8, micro=2, releaselevel='final', serial=0))"
...
meta_path = [
    ...
    None, # (!) real value is '<six._SixMetaPathImporter object at 0x7f70057c6430>'
]

modules = {} # real value of type <class 'dict'> skipped

path = [
    '/okteto/.pycharm_helpers',
    '/okteto/.pycharm_helpers/generator3',
...
path_hooks = [
    ...
    None, # (!) real value is '<function FileFinder.path_hook.<locals>.path_hook_for_FileFinder at 0x7f7005a8e160>'
]
