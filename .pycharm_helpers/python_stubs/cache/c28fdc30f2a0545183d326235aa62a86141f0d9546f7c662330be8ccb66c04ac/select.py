# encoding: utf-8
# module select
# from /usr/local/lib/python3.8/lib-dynload/select.cpython-38-x86_64-linux-gnu.so
# by generator 1.147
"""
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f700562c9a0>'

__spec__ = None # (!) real value is "ModuleSpec(name='select', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f700562c9a0>, origin='/usr/local/lib/python3.8/lib-dynload/select.cpython-38-x86_64-linux-gnu.so')"
