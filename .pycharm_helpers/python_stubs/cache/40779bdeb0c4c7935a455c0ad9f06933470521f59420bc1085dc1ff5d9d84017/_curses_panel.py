...
# from /usr/local/lib/python3.8/lib-dynload/_curses_panel.cpython-38-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
__spec__ = None # (!) real value is "ModuleSpec(name='_curses_panel', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f7004d01af0>, origin='/usr/local/lib/python3.8/lib-dynload/_curses_panel.cpython-38-x86_64-linux-gnu.so')"
