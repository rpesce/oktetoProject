# encoding: utf-8
# module _json
# from /usr/local/lib/python3.8/lib-dynload/_json.cpython-38-x86_64-linux-gnu.so
# by generator 1.147
""" json speedups """
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f70052fd580>'

__spec__ = None # (!) real value is "ModuleSpec(name='_json', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f70052fd580>, origin='/usr/local/lib/python3.8/lib-dynload/_json.cpython-38-x86_64-linux-gnu.so')"
